...
This repository contains the Jupyter notebook to fine-tune a YOLO11-based detector for pothole detection. Dataset details, requirements and steps to run are documented in the notebook. 
